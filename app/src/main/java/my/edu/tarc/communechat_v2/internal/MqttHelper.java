...
public class MqttHelper {
    ...
    private static final String serverUri = "tcp://172.16.118.222:1883";//change to your broker's IP, window key+r -> cmd -> ipconfig
    ...
    private String encode(String header, Object data) {
        ...
        switch (header) {
            ...
            case MqttHeader.CHAT_BOT: {
                Message message = (Message) data;
                temp.append(MqttHeader.CHAT_BOT)
                        .append(",")
